	...
	<script type="text/javascript">
		function change_selected(my) {
				...
				if(my.id == "activity1") {
					...
					document.getElementById("activity6_div").style.display = "none";
				...
				else if(my.id == "activity6") {
					document.getElementById("activity1_div").style.display = "none";
					document.getElementById("activity2_div").style.display = "none";
					document.getElementById("activity6_div").style.display = "block";
					document.getElementById("activity3_div").style.display = "none";
					document.getElementById("activity4_div").style.display = "none";
					document.getElementById("activity5_div").style.display = "none";
				}
			...
			<div id="contents">
				<div class="title_background">
					<p class="title">近期活动列表</p>
				</div>
				<div>
					<div id="left_sidebar">
						<ul class="nav nav-tabs nav-stacked" role="tablist">
						  <li role="presentation" class="active"><a onclick="change_selected(this)" id="activity1" >“梦想课堂”系列公益讲座</a></li>
						  <li role="presentation"><a onclick="change_selected(this)"  id="activity2"  >沪内爱心家教系列活动成功举行</a></li>
						  <li role="presentation"><a onclick="change_selected(this)"  id="activity3" >校际远程教学交流成功进行</a></li>
						  <li role="presentation"><a onclick="change_selected(this)"  id="activity4" >筑梦圆梦系列活动顺利举行</a></li>
						  <li role="presentation"><a onclick="change_selected(this)"  id="activity5" >在线支教新体验</a></li>
						  <li role="presentation"><a onclick="change_selected(this)"  id="activity6" >上海交通大学海角公益组织赴甘肃甘谷开展支教</a></li>
						</ul>
					
					</div>
					<div id="activity_main">
						<div style="margin:10 10 10 10;font-family:黑体"  id="activity1_div" >
							...
							<img src="images/ai_xin_jia_jiao.jpg" style="margin-left:50px" />
						</div>
						...
						<div style="margin:10 10 10 10;font-family:黑体;display:none" id="activity3_div" >
							<h1>校际远程教学交流成功进行</h1>
							<p>
								&nbsp&nbsp&nbsp&nbsp2014年1月1日起，海角公益组织开始进行校际远程教学交流活动。在活动当中，海角已经覆盖10余所中小学，遍及5个区县，为参与教师提供了便捷、流畅的在线远程教学交流活动新体验，得到了老师们的肯定。</p>
							<p>
								&nbsp&nbsp&nbsp&nbsp传统的校际教学交流是教育主管部门为了改变教育资源分配矛盾而提出的措施，是将重点学校与教学力量稍弱的学校进行结对共建。以往的教学交流活动动辄花费半天一天，而很多时间都耗费在路途当中，来回奔波也使参与教师疲惫不堪。随着海角视频教室的正式使用，我们的服务对象不仅仅局限于学生群体，我们也为需要实时视频交流服务的老师带去了切实的便利。</p>
							<p>
						...
						<div style="margin:10 10 10 10;font-family:黑体;display:none" id="activity4_div" >
							<h1>筑梦圆梦系列活动顺利举行</h1>
							<p>
								&nbsp&nbsp&nbsp&nbsp2014年7月起，海角公益组织前往吉林、甘肃等地进行线上线下结合的支教实践活动，活动惠及中小学生及在再培训教师超过1000余人。海角公益组织发起了筑梦圆梦系列活动，由这些学生通过海角发布自己的心愿，社会爱心人士可以在海角的爱心墙上认领心愿，从而帮助这些贫困地区的孩子们实现愿望。活动取得了良好的反响。</p>
							<p>
						...
						<div style="margin:10 10 10 10;font-family:黑体;display:none" id="activity6_div" >
							...
							<p>
								&nbsp&nbsp&nbsp&nbsp海角公益组织是专注于发展在线支教的公益组织，由上海交通大学在校学生组成。海角公益利用团队自主研发的海角实时视频教室实现了语音与视频实时互动的在线教学，通过简洁的操作完成教学所需的各项功能，保证在线教学高效流畅。</p>
							<p>
